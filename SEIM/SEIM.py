...
# def funVarianceThreshold(X1, y1, X2, y2, X3, y3):
...
if __name__ == '__main__':
    ...
    funVarianceThreshold(x_nm1, y_nm1)
    # funVarianceThreshold(x_nm1, y_nm1, x_nm2, y_nm2, x_nm3, y_nm3)
    # funSelectKBest(x_nm1, y_nm1, x_nm2, y_nm2, x_nm3, y_nm3)
    #
    # ---------- Logical regression ----------
    # acc_score_SFM_LR = mySelectFromModel(x_nm1, y_nm1, x_nm2, y_nm2, x_nm3, y_nm3, 1)
    # acc_score_RFE_LR = myRFE(x_nm1, y_nm1, x_nm2, y_nm2, x_nm3, y_nm3, 1)
    #
    # ------ Random trees classification -----
    # acc_score_SFM_RFC = mySelectFromModel(x_nm1, y_nm1, x_nm2, y_nm2, x_nm3, y_nm3, 2)
    # acc_score_RFE_RFC = myRFE(x_nm1, y_nm1, x_nm2, y_nm2, x_nm3, y_nm3, 2)
    #
    # ------ Extra trees classification ------
    # acc_score_SFM_ETC = mySelectFromModel(x_nm1, y_nm1, x_nm2, y_nm2, x_nm3, y_nm3, 3)
    # acc_score_RFE_ETC = myRFE(x_nm1, y_nm1, x_nm2, y_nm2, x_nm3, y_nm3, 3)
    #
    # ------------ Comparison SFM ------------
